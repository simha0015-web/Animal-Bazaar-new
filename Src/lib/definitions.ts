...
export type AnimalCategory = 'Cow' | 'Ox' | 'Buffalo' | 'Hen' | 'Dog' | 'Cat' | 'Pig' | 'Goat' | 'Sheep' | 'Pigeon';

export const animalCategories: AnimalCategory[] = ['Cow', 'Ox', 'Buffalo', 'Hen', 'Dog', 'Cat', 'Pig', 'Goat', 'Sheep', 'Pigeon'];
...
export const breeds: Record<AnimalCategory, string[]> = {
  Cow: ["HF","Jersey","Sahiwal","Gir","Desi","Crossbreed", "Other"],
  Ox: ["Bull","Pair Ox", "Other"],
  Buffalo: ["Murrah","Jaffarabadi","Surti","Mehsana","Local", "Other"],
  Hen: ["Country Hen","Broiler","Layer","Kadaknath", "Other"],
  Dog: ["German Shepherd","Labrador","Golden Retriever","Indie","Rottweiler", "Other"],
  Cat: ["Persian","Siamese","Indie", "Other"],
  Pig: ["Yorkshire","Landrace","Local", "Other"],
  Goat: ["Barbari", "Beetal", "Black Bengal", "Jamunapari", "Local", "Other"],
  Sheep: ["Deccani", "Nellore", "Marwari", "Local", "Other"],
  Pigeon: ["Homer", "Fantail", "Tumbler", "Local", "Other"],
};
...
export const locations = {
    ...
    "Bihar": ["Araria", "Arwal", "Banka", "Begusarai", "Bhagalpur", "Bhojpur", "Buxar", "Darbhanga", "East Champaran (Motihari)", "Gaya", "Gopalganj", "Jamui", "Jehanabad", "Kaimur (Bhabua)", "Katihar", "Khagaria", "Kishanganj", "Lakhisarai", "Madhepura", "Madhubani", "Munger (Monghyr)", "Muzaffarpur", "Nalanda", "Nawada", "Patna", "Purnia (Purnea)", "Rohtas", "Saharsa", "Samastipur", "Saran", "Sheikhpura", "Sheohar", "Sitamarhi", "Siwan", "Supaul", "Vaishali", "West Champaran"],
    "Chandigarh": ["Chandigarh"],
    "Chhattisgarh": ["Balod", "Baloda Bazar", "Bastar", "Bemetara", "Bijapur", "Bilaspur", "Dantewada (Dakshin Bastar)", "Dhamtari", "Durg", "Gariaband", "Gaurela-Pendra-Marwahi", "Janjgir-Champa", "Jashpur", "Kabirdham (Kawardha)", "Kanker (Uttar Bastar)", "Kondagaon", "Khairagarh-Chhuikhadan-Gandai", "Korba", "Koriya", "Mahasamund", "Manendragarh-Chirmiri-Bharatpur", "Mohla-Manpur-Ambagarh Chowki", "Mungeli", "Narayanpur", "Raigarh", "Raipur", "Rajnandgaon", "Sarangarh-Bilaigarh", "Sakti", "Sukma", "Surajpur", "Surguja"],
    ...
    "Nagaland": ["Chumoukedima", "Dimapur", "Kiphire", "Kohima", "Longleng", "Mokokchung", "Mon", "Niuland", "Noklak", "Peren", "Phek", "Pfutsero", "Shamator", "Tseminyu", "Tuensang", "Wokha", "Zunheboto"],
    ...
    "Punjab": ["Amritsar", "Barnala", "Bathinda", "Faridkot", "Fatehgarh Sahib", "Fazilka", "Ferozepur", "Gurdaspur", "Hoshiarpur", "Jalandhar", "Kapurthala", "Ludhiana", "Mansa", "Moga", "Muktsar", "Pathankot", "Patiala", "Rupnagar (Ropar)", "Sahibzada Ajit Singh Nagar (Mohali)", "Sangrur", "Shaheed Bhagat Singh Nagar (Nawanshahr)", "Sri Muktsar Sahib", "Tarn Taran"],
    ...
    "Uttar Pradesh": ["Agra", "Aligarh", "Ambedkar Nagar", "Amethi (Chatrapati Sahuji Mahraj Nagar)", "Amroha (J.P. Nagar)", "Auraiya", "Ayodhya (Faizabad)", "Azamgarh", "Baghpat", "Bahraich", "Ballia", "Banda", "Barabanki", "Bareilly", "Basti", "Bhadohi", "Bijnor", "Budaun", "Bulandshahr", "Chandauli", "Chitrakoot", "Deoria", "Etah", "Etawah", "Farrukhabad", "Fatehpur", "Firozabad", "Gautam Buddha Nagar", "Ghaziabad", "Ghazipur", "Gonda", "Gorakhpur", "Hamirpur", "Hapur (Panchsheel Nagar)", "Hardoi", "Hathras", "Jalaun", "Jaunpur", "Jhansi", "Kannauj", "Kanpur Dehat", "Kanpur Nagar", "Kasganj (Kanshiram Nagar)", "Kaushambi", "Kushinagar (Padrauna)", "Lakhimpur - Kheri", "Lalitpur", "Lucknow", "Maharajganj", "Mahoba", "Mainpuri", "Mathura", "Mau", "Meerut", "Mirzapur", "Moradabad", "Muzaffarnagar", "Pilibhit", "Pratapgarh", "Prayagraj (Allahabad)", "Raebareli", "Rampur", "Saharanpur", "Sambhal (Bhim Nagar)", "Sant Kabir Nagar", "Shahjahanpur", "Shamli", "Shravasti", "Siddharth Nagar", "Sitapur", "Sonbhadra", "Sultanpur", "Unnao", "Varanasi"],
...
export type State = keyof typeof locations;

export const states = Object.keys(locations).sort() as State[];

export const allDistricts = [...new Set(Object.values(locations).flat())].sort();
